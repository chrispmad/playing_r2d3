//Wrap the entire D3 script in this function. It is looking for a jsondata message sent from Shinys server session object. The data gets passed in inside the "function(data)" below.
